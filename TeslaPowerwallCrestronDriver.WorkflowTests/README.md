# TeslaPowerwallCrestronDriver processor workflow
...
```powershell
dotnet test TeslaPowerwallCrestronDriver.WorkflowTests/TeslaPowerwallCrestronDriver.WorkflowTests.csproj -c Release --list-tests
dotnet test TeslaPowerwallCrestronDriver.WorkflowTests/TeslaPowerwallCrestronDriver.WorkflowTests.csproj -c Release --filter FullyQualifiedName=CrestronHome.Workflows.teslapowerwallcrestrondriver_driver
```
