...
param(
    ...
    [string] $Package = 'TeslaPowerwallCrestronDriver.ProcessorTests'
)
$ErrorActionPreference = 'Stop'
Set-StrictMode -Version Latest
$root = $PSScriptRoot
if ($Package -ne 'TeslaPowerwallCrestronDriver.ProcessorTests') { throw 'Unsupported release package.' }
$projectDirectory = Join-Path $root $Package
foreach ($project in @('TeslaPowerwallCrestronDriver.Tests/TeslaPowerwallCrestronDriver.Tests.csproj', 'TeslaPowerwallCrestronDriver.Lifecycle.Tests/TeslaPowerwallCrestronDriver.Lifecycle.Tests.csproj')) {
    $legacy = $project -like 'TeslaPowerwallCrestronDriver.Tests/*'
